...
<head>
    ...
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Aref+Ruqaa+Ink&family=Barlow+Condensed:wght@700;800&family=Barlow:wght@400;700&family=Lato&family=Outfit:wght@300&family=Roboto+Mono:ital,wght@0,300;1,300&family=Roboto+Slab:wght@300&family=Space+Mono:wght@700&display=swap');
    </style>
...
<body>
    <main>
        <header>
            <div class="logo">
                <img src="<%= request.getContextPath() %>/assets/images/logo-transparent-svg.svg" alt="Logo">
            </div>

            <!-- <div class="leftlinks">
                <a class="leftA">Owner Manual</a>
                <a class="leftA">Worker Manual</a>
                <a class="leftA">About</a>
            </div> -->

            <div class="Rightlinks">
                <a class="login" href="Signin.jsp">Log In</a>
        ...
        <section class="first">
            <div class="leftFirst">
                <div class="websiteDescription"> STOP FINDING JOBS AND WORKERS IN OFFLINE </div>
                <div class="ownerPoint">Get More workers with less effort <a href="register.jsp">SignUp</a></div>
            </div>
            <div class="rightFirst">
                <div>
                    <img class="grid" src="<%=request.getContextPath()%>/assets/images/grid.jpg" alt="image">
                    <img class="arrow"
                ...
                <div class="multiStar">
                    <img src="https://assets.website-files.com/6391f853d48f24401d03ff53/6391f853d48f24b4b103ff70_hero_star-svg.svg"
                        alt="image">
                </div>
        ...
        <section class="second">
                ...
                <div class="totalAmount">
                    <div class="videoSec">
                        ...
                        <div class="videoRight">
                            ...
                            <div class="amountShared">Has been paid by owners to the workers</div>
                        </div>
            ...
            <div class="secondRight">
                ...
                <div class="contact">
                    <div class="images">
                        <img class="contactOne" src="  ./assets/images/blackPeople.webp" alt="BlackPeople">
                        <img class="contactTwo" src="./assets/images/indianPeople.avif" alt="IndianPeople">
                        <img class="contactThree" src="./assets/images/whitePeople.jpeg" alt="whitePeople">
                    </div>
                    <div class="aboutContact">
                        These are our top owners
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="topFeatures">
            <div class="notification">
                <div class="notificationLeft">
                    <img src="./assets/images/notificationIllustration.avif" alt="notificationImage">
                </div>
                <div class="notificationRight">
                    <div class="worker">
                        If you are a worker in this website you will receive notification, Once the owner approved your
                        Request.
                    </div>

                    <div class="owner">
                        If you are a owner in this website you will receive a notification, Once the worker requested
                        you
                        to
                        satrt the job and after completed the job.
                    </div>
                </div>
            </div>
            ...
            <div class="chat">
                <div class="chatLeft">
                    <div class="chatText">
                        You can chat with all workers and owners in this website to clarify your doubt about the jobs
                        and
                        works and you can find the chatter by their name.
                    </div>
                </div>
                <div class="chatRight">
                    <img src="./assets/images/chatIllutration.avif" alt="chatIllutration">
                </div>
        ...
        <section class="topJobs">
            ...
            <div class="cards">
                <div class="card">
                    <div class="pro">
                        <img class="cardProfile" src="./assets/images/indianPeople.avif" alt="image">
                    ...
                    <div class="buttons">
                        <a class="applyCard" onclick="workerLogin()">Apply</a>
                        <a class="cardChat">Chat</a>
                ...
                <div class="card">
                    <div class="pro">
                        <img class="cardProfile" src="./assets/images/whitePeople.jpeg" alt="image">
                ...
                <div class="card">
                    <div class="pro">
                        <img class="cardProfile" src="./assets/images/blackPeople.webp" alt="image">
